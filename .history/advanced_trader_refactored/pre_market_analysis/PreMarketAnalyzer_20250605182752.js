...
class PreMarketAnalyzer {
    ...
    async getAndUpdateHistoricalData(symbol, exchange, token, histConfig, isUnderlying) {
        ...
        const existingCandles = CsvHandler.load(csvPath);
        this.logger.info(`Loaded ${existingCandles.length} existing candles for ${symbol} from CSV.`);
        ...
        // 4. Save the complete, updated data back to the CSV
