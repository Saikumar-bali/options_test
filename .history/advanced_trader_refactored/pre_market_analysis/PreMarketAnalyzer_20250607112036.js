...
class PreMarketAnalyzer {
   ...
   async processUnderlying(underlying) {
        ...
        // ** THE FIX ** Pass the current price (atmPrice) to the S/R calculator for filtering
        const srLevels = SrCalculator.detectLevels(srCandles, atmPrice, { reactionLookback, levelsToReturn });
        ...
        this.logger.info(`  (Current Price: ${atmPrice.toFixed(2)})`);
