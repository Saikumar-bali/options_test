...
const IndicatorCalculator = require('../indicators/IndicatorCalculator'); // --- THIS LINE IS THE FIX ---
...
class MarketManager {
    ...
    async startMarketActivities() {
        ...
        this.strategy.stocks.forEach(stock => 
            IndicatorCalculator.calculateAll(stock, this.config.tradingParameters, this.logger)
        );
