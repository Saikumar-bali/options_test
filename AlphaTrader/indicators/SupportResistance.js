...
class SupportResistance {
     ...
     * @param {number} currentPrice - The current price to filter levels against.
     * @param {Object} params - Parameters { reactionLookback, levelsToReturn }.
     * @returns {Object} - { supports: Array<Object>, resistances: Array<Object> }.
     */
    static detectLevels(candles, currentPrice, params = { reactionLookback: 5, levelsToReturn: 5 }) {
        ...
        if (!candles || candles.length < params.reactionLookback + 2) {
            console.warn("Not enough candle data for S/R detection.");
            return initialState;
        }
